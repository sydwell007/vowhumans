...
function IdentityConsent() {
  ...
  return (
    <div className="content-stack">
      ...
      <section className="panel">
        <PanelTitle title="Identity register" eyebrow="4 identities" action={<InlineAction className="table-action" idleLabel={<>Filter <ChevronRight size={15}/></>} doneLabel="Showing all identities" />} />
