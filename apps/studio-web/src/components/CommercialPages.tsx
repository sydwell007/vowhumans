...
const legalProfiles: Partial<Record<(typeof legalDocuments)[number], LegalDocumentProfile>> = {
  ...
  "responsible-ai": {
    ...
    sections: [
      ...
      { id: "data", title: "Data and knowledge boundaries", copy: "Digital Colleagues should use approved, access-controlled knowledge; distinguish evidence from uncertainty; and avoid exposing private organisation or individual information." },
